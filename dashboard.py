...
def load_data():
    df = pd.read_csv('/Users/ajeeb/OneDrive/Documents/Superstore Sales Dashboard/output/superstore_clean.csv',parse_dates=['Order Date','Ship Date'])
    return df
...
st.caption(f"Showing {len(filtered):,} rows . {min_year}-{max_year} . Built by Ajeeba Farhath ")